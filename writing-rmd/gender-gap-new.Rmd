...
source(here::here("code/setup-Rmarkdown.R"))
```
...
```{r dot-net-votes, include = TRUE}
  include_graphics(here("writing-rmd", "assets", "img", "net-votes.pdf"))
```
...
```{r dot-net-mechanisms, include = TRUE}
  include_graphics(here("writing-rmd", "assets", "img", "net-vote-mechanisms.pdf"))
```
...
```{r dot-net-gap, include = TRUE}
  include_graphics(here("writing-rmd", "assets", "img", "net-gap-mechanisms.pdf"))
```
...
load(here("writing-rmd", "assets", "r-dump", "03-descriptives.Rdata"))
```
...
```{r load-mcmc}
load(here("writing-rmd", "assets", "r-dump", "05-viz.Rdata"))
```
