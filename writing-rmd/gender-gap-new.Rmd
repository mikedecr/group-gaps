...
date: |
  | `r format(Sys.time(), '%B %d, %Y')`\thanks{
       Commit \texttt{`r stringr::str_sub(stringr::str_replace(system("git log", intern = TRUE)[1], "commit ", ""), 1L, 7L)`} on branch \texttt{`r stringr::str_replace(system("git status", intern = TRUE)[1], "On branch ", "")`}. 
       View the most recent public version \href{https://github.com/mikedecr/group-gaps/blob/master/writing-rmd/gender-gap-new.pdf}{here}.
    }
abstract: |
